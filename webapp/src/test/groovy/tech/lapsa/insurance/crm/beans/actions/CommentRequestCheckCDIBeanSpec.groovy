...
import tech.lapsa.insurance.crm.beans.actions.CommentRequestCDIBean.CommentRequestCheckCDIBean
import tech.lapsa.insurance.crm.rows.RequestRow

class CommentRequestCheckCDIBeanSpec extends Specification {
    ...
    @Unroll
    def "Comment Request allowance is '#expAllowed' on role '#role'"() {
	given:
	...
	def bean = new CommentRequestCheckCDIBean(rrs: rrs)
    ...
    @Unroll
    def "Comment Request allowance is '#expAllowed' on selection of #number rows"() {
	given:
