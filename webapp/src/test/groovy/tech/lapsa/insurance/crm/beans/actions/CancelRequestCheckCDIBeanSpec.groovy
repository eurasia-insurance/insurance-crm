...
class CancelRequestCheckCDIBeanSpec extends Specification {
    ...
    @Unroll
    def "Cancel Request allowance is '#expAllowed' on role '#role'"() {
	given:
	...
	def bean = new CancelRequestCheckCDIBean(rrs: rrs)
    ...
    @Unroll
    def "Cancel Request allowance is '#expAllowed' on insuranfce request status '#insuranceRequestStatus'"() {
	given:
    ...
    @Unroll
    def "Cancel Request allowance is '#expAllowed' on progress status '#progressStatus'"() {
	given:
    ...
    @Unroll
    def "Cancel Request allowance is '#expAllowed' on selection of #number rows"() {
	given:
    ...
    @Unroll
    def "Cancel Request allowance is '#expAllowed' on no multiple selection where of row's status is '#insuranceRequestStatus'"() {
	given:
