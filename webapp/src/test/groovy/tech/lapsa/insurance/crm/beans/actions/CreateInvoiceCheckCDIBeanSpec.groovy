...
class CreateInvoiceCheckCDIBeanSpec extends Specification {
    ...
    @Unroll
    def "Create Invoice allowance is '#expAllowed' on role '#role'"() {
	given:
	...
	def bean = new CreateInvoiceCheckCDIBean(rrs: rrs)
    ...
    @Unroll
    def "Create Invoice allowance is '#expAllowed' on insuranfce request status '#insuranceRequestStatus'"() {
	given:
    ...
    @Unroll
    def "Create Invoice allowance is '#expAllowed' on progress status '#progressStatus'"() {
	given:
    ...
    @Unroll
    def "Create Invoice allowance is '#expAllowed' on selection of #number rows"() {
	given:
